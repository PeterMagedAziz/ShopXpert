class FavoritesModel {
  ...
  FavoritesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null ? DataFavorites.fromJson(json['data']) : null;
  }
}
...
class DataFav {
  int? id;
  ProductFavoritesData? product;

  DataFav.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    product = ProductFavoritesData.fromJson(json['product']);
  }
}
